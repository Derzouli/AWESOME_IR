...
void SYS_Initialize ( void* data )
{
    ...
    // SPP +
    SYS_PORTS_RemapOutput(PORTS_ID_0, OTPUT_FUNC_U2TX, OUTPUT_PIN_RPE8);
    SYS_PORTS_RemapInput(PORTS_ID_0, INPUT_FUNC_U2RX, INPUT_PIN_RPE9);
    ANSELE = ANSELE & (~(1<<9));
    // SPP -
