/*******************************************************************************
  ...
  Description:
    ...
    SYS_MESSAGE(message)                Prints a static message string.
    
    SYS_DEBUG_MESSAGE(level, message)   Prints a static message string, 
                                        depending on a global error level.
                                        
    SYS_PRINT(fmt, ...)                 Prints a "printf" style formatted 
                                        message with optional parameters.
                                        
    SYS_DEBUG_PRINT(level, fmt, ...)    Prints a formatted message, depending 
                                        on global error level setting.

  Remarks:
    The default debug and message macro definitions remove the messages and 
    message function calls from the build.  To utilize the messages defined in 
    the source code, define the SYS_DEBUG_USE_CONSOLE macro or override the 
    definitions of the individual debug print and message macros.
 *******************************************************************************/
...
/* Macro:
  ...
  Remarks:
    Compliles out if not built for debugging.
*/
