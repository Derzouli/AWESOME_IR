...
/* Function:
  ...
  Summary:
    De initializes the specific module instance of the TMR module
...
/* Function:
  ...
  Example:
    ...
    handle20ms = SYS_TMR_FLAG_PERIODIC ( 20, 1, Test_Callback, SYS_TMR_FLAG_PERIODIC );
  ...
  Remarks:
    ...
    the client has been notified, i.e:
...
/* Function:
  ...
  Description:
    ...
    Once the time-out occurs and the notification is sent the timer object will be invalidated.
  ...
  Remarks:
    ...
    This function is equivalent to
    SYS_TMR_ObjectCreate(periodMs, context, callback, SYS_TMR_FLAG_SINGLE | SYS_TMR_FLAG_AUTO_DELETE);
*/
...
/* Function:
  ...
  Returns:
    A valid timer handler of type SYS_TMR_HANDLE is returned if the call is successful.
    SYS_TMR_HANDLE_INVALID otherwise.
...
// *****************************************************************************
// *****************************************************************************
// Section: SYS TMR Module Count and resolution routines
// *****************************************************************************
// *****************************************************************************
