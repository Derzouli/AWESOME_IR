...
/* Function:
  ...
  Return:
    ...
    This value is less than SYS_STATUS_ERROR. Once the Initialize operation has 
	been called, the Deinitialize operation must be called before the Initialize 
	operation can be called again.
...
/* Function:
  ...
  Description:
    ...
    zeros all tags. Sets coherency attribute for kseg0.
