...
/**************************************************************************
  ...
  Description:
    ...
    This value identifies the current power status/state of a system module
    (including device drivers). It is used to indicate that the module
    should prepare to enter an run-full state.
...
/*************************************************************************
  ...
  Description:
    System Module Deinitialization Routine Pointer
