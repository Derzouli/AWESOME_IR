...
#define DRV_USBFS_HOST_IRP_PER_FRAME_NUMBER        5
#define _DRV_USBFS_SW_EP_NUMBER DRV_USBFS_HOST_IRP_PER_FRAME_NUMBER
...
typedef struct _DRV_USBFS_OBJ_STRUCT
{
    ...
    _DRV_USBFS_FOR_HOST(bool, attachDebouncing);
