...
typedef enum
{
    ...
    /* Clock input to the timer module is external with clock
...
// *****************************************************************************
// *****************************************************************************
// Section: TMR Driver 16-bit mode functions These functions should be used only
// the Timer is configured in 16 bit mode Using the generic API version above is
// preferred
// *****************************************************************************
// *****************************************************************************
...
// *****************************************************************************
// *****************************************************************************
// Section: TMR Driver 32-bit mode functions
// These functions should be used only the Timer is configured in 32 bit mode
// Using the generic API version above is preferred
// *****************************************************************************
// *****************************************************************************
