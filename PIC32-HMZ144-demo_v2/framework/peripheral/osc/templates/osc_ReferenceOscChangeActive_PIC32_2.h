...
PLIB_TEMPLATE bool OSC_ReferenceOscSourceChangeIsActive_PIC32_2( OSC_MODULE_ID index , OSC_REFERENCE referenceOsc )
{
    ...
    case OSC_REFERENCE_1:
            return _SFR_BIT_READ(_OSC_REF_CHANGE_ACTIVE_1_VREG(index),
                                 _OSC_REF_CHANGE_ACTIVE_1_POS(index) );

    case OSC_REFERENCE_2:
            return _SFR_BIT_READ(_OSC_REF_CHANGE_ACTIVE_2_VREG(index),
                                  _OSC_REF_CHANGE_ACTIVE_2_POS(index) );

    case OSC_REFERENCE_3:
            return _SFR_BIT_READ(_OSC_REF_CHANGE_ACTIVE_3_VREG(index),
                                  _OSC_REF_CHANGE_ACTIVE_3_POS(index) );

    case OSC_REFERENCE_4:
            return _SFR_BIT_READ(_OSC_REF_CHANGE_ACTIVE_4_VREG(index),
                                  _OSC_REF_CHANGE_ACTIVE_4_POS(index) );
    }
