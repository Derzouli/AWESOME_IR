...
PLIB_TEMPLATE void OSC_ReferenceOscEnable_PIC32_2( OSC_MODULE_ID index , OSC_REFERENCE referenceOsc )
{
    ...
    case OSC_REFERENCE_1: 	
    	_SFR_BIT_SET(_OSC_REF_CLK_ENABLE_1_VREG(index),
                     _OSC_REF_CLK_ENABLE_1_POS(index) );
		break;
		
	case OSC_REFERENCE_2: 	
		_SFR_BIT_SET(_OSC_REF_CLK_ENABLE_2_VREG(index),
                     _OSC_REF_CLK_ENABLE_2_POS(index) );
		break;
		
	case OSC_REFERENCE_3: 	
		_SFR_BIT_SET(_OSC_REF_CLK_ENABLE_3_VREG(index),
                     _OSC_REF_CLK_ENABLE_3_POS(index) );
		break;
		
	case OSC_REFERENCE_4: 	
		_SFR_BIT_SET(_OSC_REF_CLK_ENABLE_4_VREG(index),
                     _OSC_REF_CLK_ENABLE_4_POS(index) );
		break;
	}
}
...
PLIB_TEMPLATE void OSC_ReferenceOscDisable_PIC32_2( OSC_MODULE_ID index , OSC_REFERENCE referenceOsc )
{
	...
	{
    case OSC_REFERENCE_1: 	
    	_SFR_BIT_CLEAR(_OSC_REF_CLK_ENABLE_1_VREG(index),
                       _OSC_REF_CLK_ENABLE_1_POS(index) );
		break;
		
	case OSC_REFERENCE_2: 	
		_SFR_BIT_CLEAR(_OSC_REF_CLK_ENABLE_2_VREG(index),
                       _OSC_REF_CLK_ENABLE_2_POS(index) );
		break;
		
	case OSC_REFERENCE_3: 	
		_SFR_BIT_CLEAR(_OSC_REF_CLK_ENABLE_3_VREG(index),
                       _OSC_REF_CLK_ENABLE_3_POS(index) );
		break;
		
	case OSC_REFERENCE_4: 	
		_SFR_BIT_CLEAR(_OSC_REF_CLK_ENABLE_4_VREG(index),
                       _OSC_REF_CLK_ENABLE_4_POS(index) );
		break;
	}
}
...
PLIB_TEMPLATE bool OSC_ReferenceOscIsEnabled_PIC32_2( OSC_MODULE_ID index , OSC_REFERENCE referenceOsc )
{
	...
	{
    case OSC_REFERENCE_1: 	
    	    return _SFR_BIT_READ(_OSC_REF_CLK_ENABLE_1_VREG(index),
                       			 _OSC_REF_CLK_ENABLE_1_POS(index) );
		
	case OSC_REFERENCE_2: 	
		    return _SFR_BIT_READ(_OSC_REF_CLK_ENABLE_2_VREG(index),
                             	 _OSC_REF_CLK_ENABLE_2_POS(index) );
		
	case OSC_REFERENCE_3: 	
		    return _SFR_BIT_READ(_OSC_REF_CLK_ENABLE_3_VREG(index),
                             	 _OSC_REF_CLK_ENABLE_3_POS(index) );
		
	case OSC_REFERENCE_4: 	
		    return _SFR_BIT_READ(_OSC_REF_CLK_ENABLE_4_VREG(index),
                             	 _OSC_REF_CLK_ENABLE_4_POS(index) );
	}
}
