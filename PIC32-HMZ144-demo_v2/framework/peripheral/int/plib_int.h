...
/*  INT global state type definition
  ...
  Description:
    Data type used for interrupt enable/disable functions.
...
/*
  ...
  Parameters:
   ...
   interrupt_state - value returned from previous call to 
...
/* Function :  PLIB_INT_ExistsSingleVectorShadowSet( INT_MODULE_ID index )
  ...
  Summary:
    Identifies whether the SingleVectorShadowSet feature exists on the INT module 

  Description:
    This function identifies whether the SingleVectorShadowSet feature is available on the INT module.
...
/* Function :  PLIB_INT_ExistsVectorSelect( INT_MODULE_ID index )
  ...
  Summary:
    Identifies whether the VectorSelect feature exists on the INT module 

  Description:
    This function identifies whether the VectorSelect feature is available on the INT module.
    When this function returns true, these functions are supported on the device: 
...
/* Function :  PLIB_INT_ExistsProximityTimerEnable( INT_MODULE_ID index )
  ...
  Summary:
    Identifies whether the ProximityTimerEnable feature exists on the INT module 

  Description:
    This function identifies whether the ProximityTimerEnable feature is available on the INT module.
    When this function returns true, these functions are supported on the device: 
...
/* Function :  PLIB_INT_ExistsProximityTimerControl( INT_MODULE_ID index )
  ...
  Summary:
    Identifies whether the ProximityTimerControl feature exists on the INT module 

  Description:
    This function identifies whether the ProximityTimerControl feature is available on the INT module.
    When this function returns true, these functions are supported on the device: 
...
/* Function :  PLIB_INT_ExistsExternalINTEdgeSelect( INT_MODULE_ID index )
  ...
  Summary:
    Identifies whether the ExternalINTEdgeSelect feature exists on the INT module 

  Description:
    This function identifies whether the ExternalINTEdgeSelect feature is available on the INT module.
    When this function returns true, these functions are supported on the device: 
...
/* Function :  PLIB_INT_ExistsINTCPUPriority( INT_MODULE_ID index )
  ...
  Summary:
    Identifies whether the INTCPUPriority feature exists on the INT module 

  Description:
    This function identifies whether the INTCPUPriority feature is available on the INT module.
    When this function returns true, these functions are supported on the device: 
...
/* Function :  PLIB_INT_ExistsINTCPUVector( INT_MODULE_ID index )
  ...
  Summary:
    Identifies whether the INTCPUVector feature exists on the INT module 

  Description:
    This function identifies whether the INTCPUVector feature is available on the INT module.
    When this function returns true, these functions are supported on the device: 
    - PLIB_INT_VectorGet
...
/* Function :  PLIB_INT_ExistsSourceFlag( INT_MODULE_ID index )
  ...
  Summary:
    Identifies whether the SourceFlag feature exists on the INT module 

  Description:
    This function identifies whether the SourceFlag feature is available on the INT module.
    When this function returns true, these functions are supported on the device: 
...
/* Function :  PLIB_INT_ExistsSourceControl( INT_MODULE_ID index )
  ...
  Summary:
    Identifies whether the SourceControl feature exists on the INT module 

  Description:
    This function identifies whether the SourceControl feature is available on the INT module.
    When this function returns true, these functions are supported on the device: 
...
/* Function :  PLIB_INT_ExistsVectorPriority( INT_MODULE_ID index )
  ...
  Summary:
    Identifies whether the VectorPriority feature exists on the INT module 

  Description:
    This function identifies whether the VectorPriority feature is available on the INT module.
    When this function returns true, these functions are supported on the device: 
...
/* Function :  PLIB_INT_ExistsCPUCurrentPriorityLevel( INT_MODULE_ID index )
  ...
  Summary:
    Identifies whether the CPUCurrentPriorityLevel feature exists on the INT module 

  Description:
    This function identifies whether the CPUCurrentPriorityLevel feature is available on the INT module.
    When this function returns true, these functions are supported on the device: 
...
/* Function :  PLIB_INT_ExistsEnableControl( INT_MODULE_ID index )
  ...
  Summary:
    Identifies whether the EnableControl feature exists on the INT module 

  Description:
    This function identifies whether the EnableControl feature is available on the INT module.
    When this function returns true, these functions are supported on the device: 
    - PLIB_INT_Enable
    - PLIB_INT_Disable
    - PLIB_INT_IsEnabled
...
//******************************************************************************
/* Function :  PLIB_INT_ExistsShadowRegisterAssign( INT_MODULE_ID index )

  Summary:
    Identifies whether the ShadowRegisterAssign feature exists on the INT module 

  Description:
    This function identifies whether the ShadowRegisterAssign feature is available on the INT module.
    When this function returns true, these functions are supported on the device: 
...
//******************************************************************************
/* Function :  PLIB_INT_ExistsVariableOffset( INT_MODULE_ID index )

  Summary:
    Identifies whether the VariableOffset feature exists on the INT module 

  Description:
    This function identifies whether the VariableOffset feature is available on the INT module.
    When this function returns true, these functions are supported on the device: 
...
//******************************************************************************
/* Function :  PLIB_INT_ExistsSoftwareNMI( INT_MODULE_ID index )

  Summary:
    Identifies whether the SoftwareNMI feature exists on the INT module 

  Description:
    This function identifies whether the SoftwareNMI feature is available on the INT module.
    When this function returns true, these functions are supported on the device: 
