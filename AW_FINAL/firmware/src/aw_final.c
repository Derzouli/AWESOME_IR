...
/* Application Data
  ...
  Remarks:
    This structure should be initialized by the AW_FINAL_Initialize function.

    Application strings and buffers are be defined outside this structure.
*/

AW_FINAL_DATA appData;
...
USB_DEVICE_HID_EVENT_RESPONSE AW_FINAL_USBDeviceHIDEventHandler
(
...
{
    AW_FINAL_DATA * appData = (AW_FINAL_DATA *)userData;
...
/*******************************************************************************
  Function:
    void AW_FINAL_USBDeviceEventHandler (USB_DEVICE_EVENT event,
        ...
        void * eventData, uintptr_t context)
{
    ...
    switch(event)
    {
        ...
        case USB_DEVICE_EVENT_DECONFIGURED:
            ...
            appData.state = AW_FINAL_STATE_WAIT_FOR_CONFIGURATION;
            break;
        ...
        case USB_DEVICE_EVENT_CONFIGURED:
            ...
            if(configurationValue->configurationValue == 1)
            {
                ...
                USB_DEVICE_HID_EventHandlerSet(appData.hidInstance,
                        AW_FINAL_USBDeviceHIDEventHandler, (uintptr_t)&appData);
            }
            break;
...
void AW_FINAL_ProcessSwitchPress(void)
{
 ...
 ********************************************************/
//
//void AW_FINAL_KeyboardLEDStatus(void)
//{
...
//    {
//        BSP_LEDOn(AW_FINAL_USB_LED_2);
//    }
//    else
//    {
//        BSP_LEDOff(AW_FINAL_USB_LED_2);
//    }
//
//    if(keyboardOutputReport.ledState.capsLock
//            == KEYBOARD_LED_STATE_ON)
//    {
//        BSP_LEDOn(AW_FINAL_USB_LED_1);
//    }
//    else
//    {
//        BSP_LEDOff(AW_FINAL_USB_LED_1);
//    }
//}
...
void AW_FINAL_EmulateKeyboard(void)
{
...
void AW_FINAL_Initialize ( void )
{
    ...
    appData.state = AW_FINAL_STATE_INIT;
...
void AW_FINAL_Tasks ( void )
{
    ...
    switch ( appData.state )
    {
        ...
        case AW_FINAL_STATE_INIT:
        {
            ...
            if(appData.deviceHandle != USB_DEVICE_HANDLE_INVALID)
            {
                ...
                USB_DEVICE_EventHandlerSet(appData.deviceHandle,
                        AW_FINAL_USBDeviceEventHandler, 0);
        ...
        case AW_FINAL_STATE_WAIT_FOR_CONFIGURATION:
            ...
            if(appData.isConfigured)
            {
                ...
                appData.state = AW_FINAL_STATE_CHECK_IF_CONFIGURED;
            }

            break;

        case AW_FINAL_STATE_CHECK_IF_CONFIGURED:
            ...
            if(appData.isConfigured)
            {
                appData.state = AW_FINAL_STATE_SWITCH_PROCESS;
            }
            else
            {
        ...
        case AW_FINAL_STATE_SWITCH_PROCESS:

            /* Process the switch state and go to the
             * next state. */

            AW_FINAL_ProcessSwitchPress();
            appData.state = AW_FINAL_STATE_CHECK_FOR_OUTPUT_REPORT;
            break;

        case AW_FINAL_STATE_CHECK_FOR_OUTPUT_REPORT:
            ...
            appData.state = AW_FINAL_STATE_EMULATE_KEYBOARD;
            break;

        case AW_FINAL_STATE_EMULATE_KEYBOARD:

            if(appData.isReportSentComplete)
            {
                /* This means report can be sent*/

                AW_FINAL_EmulateKeyboard();
