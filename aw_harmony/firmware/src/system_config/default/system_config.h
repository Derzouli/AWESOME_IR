...
#define AWESOME_HEARTBEAT_TMR DRV_TMR_INDEX_0
#define AWESOME_HEARTBEAT_TMR_IS_PERIODIC true
#define AWESOME_HEARTBEAT_TMR_PERIOD 0xFFFF
#define AWESOME_HEARTBEAT_COUNT_MAX 6
#define AWESOME_HEARTBEAT_PORT PORT_CHANNEL_H
#define AWESOME_HEARTBEAT_PIN PORTS_BIT_POS_2
